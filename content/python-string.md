...
The format method is used to dynamically build a string. The
...
When the substring is not found, the rindex method raises
ValueError exception.
...
A string can be split with the split or the rsplit
