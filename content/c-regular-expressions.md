...
We can find out the position of the matches in the string with the
...
This is the output. Remember that match.Groups[0].Value equals to 
match.Value.
...
Case-insensitive matching is enabled by setting RegexOptions.Compiled
